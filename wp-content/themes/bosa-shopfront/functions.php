...
if (!function_exists('bosa_shopfront_enqueue_styles')):
    /**
     * @since Bosa Shopfront 1.0.0
     */
    function bosa_shopfront_enqueue_styles()
    {
        require_once get_theme_file_path('inc/wptt-webfont-loader.php');

        wp_enqueue_style(
            'bosa-shopfront-style-parent',
        ...
        wp_enqueue_style(
            'bosa-shopfront-google-fonts-two',
        ...
        wp_enqueue_script('bosa-shopfront-custom-woo', get_stylesheet_directory_uri() . '/assets/js/custom-woo.js', array('jquery'), '1.0', true);

    }

endif;
add_action('wp_enqueue_scripts', 'bosa_shopfront_enqueue_styles', 10);

/**
 * Registers menu location. 
 * @since Bosa Shopfront 1.0.0
 */
function bosa_shopfront_menu_register()
{
    register_nav_menu(
        'menu-4',
        esc_html__('Category Menu', 'bosa-shopfront')
    );
}
add_action('after_setup_theme', 'bosa_shopfront_menu_register');

/**
 * Add cart link
 * @since Bosa Shopfront 1.0.0
 */
if (!function_exists('bosa_shopfront_cart_link')) {
    function bosa_shopfront_cart_link()
    {
        ?>
 ...
 * @since Bosa Shopfront 1.0.0
 */
if (!function_exists('bosa_shopfront_header_cart')) {
    function bosa_shopfront_header_cart()
    {
        ?>
        <div class="header-cart">
            <div class="header-cart-block">
                <div class="header-cart-inner">
                    <?php bosa_shopfront_cart_link(); ?>
 ...
 * @since Bosa Shopfront 1.0.0
 */
if (!function_exists('bosa_shopfront_header_add_to_cart_fragment')) {
    function bosa_shopfront_header_add_to_cart_fragment($fragments)
    {
        ob_start();
        bosa_shopfront_cart_link();
        $fragments['a.cart-contents'] = ob_get_clean();
        return $fragments;
    }
    add_filter('woocommerce_add_to_cart_fragments', 'bosa_shopfront_header_add_to_cart_fragment');
}
 ...
 * @since Bosa Shopfront 1.0.0
 */
if (!function_exists('bosa_shopfront_head_wishlist')) {
    function bosa_shopfront_head_wishlist()
    {
            ...
            <div class="header-wishlist">
                <a href="<?php echo esc_url($wishlist_url); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e('Wishlist', 'bosa-shopfront'); ?>
                    </span>
                </a>
            </div>
            <?php
 ...
 * @since Bosa Shopfront 1.0.0
 */
if (!function_exists('bosa_shopfront_head_compare')) {
    function bosa_shopfront_head_compare()
    {
        if (function_exists('yith_woocompare_constructor')) {
            ...
            <div class="header-compare">
                <a class="compare added" rel="nofollow" href="<?php echo esc_url($yith_woocompare->obj->view_table_url()); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e('Compare', 'bosa-shopfront'); ?>
                    </span>
                </a>
            </div>
            <?php
 ...
 * @since Bosa Shopfront 1.0.0
 */
if (!function_exists('bosa_shopfront_my_account')) {
    function bosa_shopfront_my_account()
    {
            ...
            <div class="header-my-account">
                <div class="header-login">
                    <a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>">
                        ...
                        <span class="info-tooltip">
                            <?php esc_html_e('My Account', 'bosa-shopfront'); ?>
                        </span>
                    </a>
                </div>
            </div>
...
function bosa_header_advertisement_banner()
{
    ...
    if (!empty($bannerImageID)) {
        ...
        <div class="header-advertisement-banner">
            <a href="<?php echo esc_url(get_theme_mod('header_advertisement_banner_link', '#')); ?>"
                alt="<?php echo esc_attr($alt); ?>" target="_blank">
 ...
 * @return array.
 */
function bosa_shopfront_get_pages()
{
 ...
 * @since Bosa Shopfront 1.0.0
 */
if (!function_exists('bosa_shopfront_blog_advertisement_banner')) {
    function bosa_shopfront_blog_advertisement_banner()
    {
        ...
        if (is_array($blog_advertisement_banner_obj)) {
            ...
            <div class="section-advert text-center">
                <a href="<?php echo esc_url(get_theme_mod('blog_advertisement_banner_link', '#')); ?>"
                    alt="<?php echo esc_attr($alt); ?>" target="<?php echo esc_attr($advert_target); ?>">
...
if (!function_exists('bosa_shopfront_grid_thumbnail_date')):
    /**
     * Prints HTML with meta information for the tags and comments.
     */
    function bosa_shopfront_grid_thumbnail_date()
    {
                    ...
                    comments_popup_link(
                        sprintf(
                            wp_kses(
                                ...
                                __('Comment<span class="screen-reader-text"> on %s</span>', 'bosa-shopfront'),
                                array(
                                    'span' => array(
                                        'class' => array(),
                                    ),
...
if (!function_exists('bosa_get_intermediate_image_sizes')) {
    ...
    function bosa_get_intermediate_image_sizes()
    {
        ...
        $data = array(
            'full' => esc_html__('Full Size', 'bosa-shopfront'),
            'large' => esc_html__('Large Size', 'bosa-shopfront'),
            'medium' => esc_html__('Medium Size', 'bosa-shopfront'),
            'medium_large' => esc_html__('Medium Large Size', 'bosa-shopfront'),
            'thumbnail' => esc_html__('Thumbnail Size', 'bosa-shopfront'),
            '1536x1536' => esc_html__('1536x1536 Size', 'bosa-shopfront'),
            '2048x2048' => esc_html__('2048x2048 Size', 'bosa-shopfront'),
            'bosa-1920-550' => esc_html__('1920x550 Size', 'bosa-shopfront'),
            'bosa-1370-550' => esc_html__('1370x550 Size', 'bosa-shopfront'),
            'bosa-590-310' => esc_html__('590x310 Size', 'bosa-shopfront'),
            'bosa-420-380' => esc_html__('420x380 Size', 'bosa-shopfront'),
            'bosa-420-300' => esc_html__('420x300 Size', 'bosa-shopfront'),
            'bosa-420-200' => esc_html__('420x200 Size', 'bosa-shopfront'),
            'bosa-290-150' => esc_html__('290x150 Size', 'bosa-shopfront'),
            'bosa-80-60' => esc_html__('80x60 Size', 'bosa-shopfront'),
        );
...
if (!function_exists('bosa_shopfront_archive_post_layout_filter')) {
    /**
     ...
     * @return array
     */
    add_filter('bosa_archive_post_layout_filter', 'bosa_shopfront_archive_post_layout_filter');
    function bosa_shopfront_archive_post_layout_filter($post_layout)
    {
...
if (!function_exists('bosa_shopfront_header_layout_filter')) {
    /**
     ...
     * @return array
     */
    add_filter('bosa_header_layout_filter', 'bosa_shopfront_header_layout_filter');
    function bosa_shopfront_header_layout_filter($header_layout)
    {
        $added_header = array(
...
if (!function_exists('bosa_shopfront_footer_layout_filter')) {
    /**
     ...
     * @return array
     */
    add_filter('bosa_footer_layout_filter', 'bosa_shopfront_footer_layout_filter');
    function bosa_shopfront_footer_layout_filter($footer_layout)
    {
        $added_footer = array(
 ...
 * @return array
 */
function bosa_shopfront_get_product_categories()
{
...
// Add Buy now Button this code add button only product single page
// function sbw_wc_add_buy_now_button_single()
// {
//     global $product;
//     printf('<button id="sbw_wc-adding-button" type="submit" name="sbw-wc-buy-now" value="%d" 
//     class="single_add_to_cart_button buy_now_button button alt">%s</button>',
//         $product->get_ID(),
