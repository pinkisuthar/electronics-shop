...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_shopfront_blog_advertisement_banner(); ?>
			...
			<?php get_template_part( 'template-parts/featured-advertisement/featured-advertisement' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-shopfront' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-shopfront' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-shopfront' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-shopfront' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-shopfront' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
