...
function bosa_shopfront_default_styles(){
	...
	# Responsive Featured-Advertisement
	if( get_theme_mod( 'disable_mobile_featured_advertisement', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
...
add_action( 'wp_head', 'bosa_shopfront_default_styles', 99 );