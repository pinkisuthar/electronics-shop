...
// Save Settings //
function scurf_render_settings() { 
    ...
    $selected_timezone = get_option('scurf_timezone', 'Asia/Dhaka');
?>
<div class="section-divider">
    ...
    <div class="referral-system">
        ...
        <form method="post" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>">
            <input type="hidden" name="action" value="scurf_save_system_settings" />
            ...
            <table class="general-table">
                ...
                <tr <?php scurf_add_alt_class(); ?> id="fixed-points-row" <?php if ($points_type_for_woocommerce_order !== 'fixed') echo 'style="display: none;"'; ?>>
                ...
                <tr <?php scurf_add_alt_class(); ?> id="percentage-points-row" <?php if ($points_type_for_woocommerce_order !== 'percentage') echo 'style="display: none;"'; ?>>
            ...
            <table class="general-table">
                <tr class="settings-head">
                    <th>
                        <label for="head_label">
                            <strong>
                                <?php _e('Timezone Settings', 'user-referral'); ?>
                            </strong>
                        </label>
                    </th>
                </tr>
                <tr>
                    <th><label for="scurf_timezone"><?php _e('Set Timezone', 'user-referral'); ?></label></th>
                    <td>
                        <select name="scurf_timezone" id="scurf_timezone">
                            <?php
...
<?php }
// Save Settings //
function scurf_save_system_settings() {
    check_admin_referer( 'scurf_save_system_settings' );
...
add_action('admin_post_scurf_save_system_settings', 'scurf_save_system_settings');
?>