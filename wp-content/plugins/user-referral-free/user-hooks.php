...
function scurf_add_settings_link( $links ) {
    $settings_link_1 = '<a href="admin.php?page=user-referral-free-settings">Settings</a>';
    
    $settings_link_2 = '<a href="https://www.mdmarufadnansami.com" target="_blank"><span>Developer</span></a>';

    $settings_link_3 = '<a href="https://softclever.com/out/62397/" target="_blank"><span style="font-weight: bold;color: red;">Buy Premium</span></a>';
    
    array_push( $links, $settings_link_1, $settings_link_2, $settings_link_3 );
    return $links;
}
?>