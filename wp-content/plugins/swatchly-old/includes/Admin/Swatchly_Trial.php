 ...
 * Class.
 */
if ( ! class_exists( 'Swatchly_Trial' ) ) {
    final class Swatchly_Trial {
        ...
        public function __construct() {
            ...
            $this->prefix = 'swatchly';
            $this->pro_file = 'swatchly-pro/swatchly-pro.php';
            $this->data_center = 'https://feed.hasthemes.com/swatchly/tw/';
            $this->initial_page = admin_url( 'admin.php?page=swatchly-admin' );
            $this->screen_ids =  array('toplevel_page_swatchly-admin');
